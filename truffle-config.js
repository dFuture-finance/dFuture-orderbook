...
//const HDWalletProvider = require('@truffle/hdwallet-provider');
const infuraKey = "f066f7dd630447c69cd17d284c73c3fd";
...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
     provider: () => new HDWalletProvider(mnemonic, `https://rinkeby.infura.io/v3/16025ca0d94546daa19e53bf3d6e264e`),
    ...
    kovan: {
     provider: () => new HDWalletProvider(mnemonic, `https://kovan.infura.io/v3/2ef221a0a7574ba0b439a2684e1909c4`),
    ...
    binance_main: {
     ...
     confirmations: 2,    // # of confs to wait between deployments. (default: 0)
     timeoutBlocks: 2000,  // # of blocks before a deployment times out  (minimum/default: 50)
     gasPrice: 6000000000,  // 2 gwei (in wei) (default: 100 gwei)
     networkCheckTimeout: 1800000,
     skipDryRun: true     // Skip dry run before migrations? (default: false for public nets )
    },
    binance_test: {
     ...
     confirmations: 2,    // # of confs to wait between deployments. (default: 0)
     timeoutBlocks: 2000,  // # of blocks before a deployment times out  (minimum/default: 50)
     gasPrice: 20000000000,  // 2 gwei (in wei) (default: 100 gwei)
     networkCheckTimeout: 1800000,
     skipDryRun: true     // Skip dry run before migrations? (default: false for public nets )
    },
    mainnet: {
     provider: () => new HDWalletProvider(mnemonic, `https://mainnet.infura.io/v3/2ef221a0a7574ba0b439a2684e1909c4`),
